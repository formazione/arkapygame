...
def get_score():
    ...
    if "score2.txt" in os.listdir():
        with open("score2.txt", "r") as file:
            # print("Score2max = " + file.readlines()[0])
            if file.readlines() == []:
                with open("score2.txt", "w") as filewrite:
                    filewrite.write("100")
                    score2max = 100
        with open("score2.txt", "r") as file:
            # print(file.readlines())
            score2max = int(file.readlines()[0])
    else:
