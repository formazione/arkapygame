...
class Bar(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, w=60, h=10, color="RED"):
        super().__init__()
        self.x = x
        self.y = y
        self.w = w
...
def mainloop():
    ...
    while loop2:
        ...
        pygame.draw.rect(screen, (0, 0, 0), (bar2.x, bar2.y, bar2.w, bar2.h))
...
def mainmenu():
    ...
    global game, randomstage, bricks
    
    
    screen.fill((0, 0, 0))
    bricks = create_bricks1()
    show_bricks()
    write("ARKAGAME", 200, 23, color="yellow")
    write("A Game by Giovanni Gatto", 200, 280, color="red")
    write("CHOOSE YOUR GAME", 200, 320, color="green")
    ...
    pygame.draw.line(screen, "red", (0, 260), (500, 260), 2)
    ball.x = 250
    ball.y = 220
    ball.color = YELLOW
    ball.update()
...
def init_screen():
    ...
    pygame.display.set_caption("ArkaGame 6.0")
...
Sprites
---------------------------------------'''
# Inistralizing sound screen
screen, clock, = init_screen()
# sounds
sounds = load_sounds()
# Fonts
font = create_fonts()
font2 = create_fonts(size=20)
# Images
background = pygame.image.load("img\\background.png").convert()
barrier = pygame.image.load("img\\barrier.png").convert()
# sprites - The bar and the ball istance of Bar and Ball
bar = Bar(10, 480)
ball = Ball(100, 300)
bar2 = Bar(100, 40, w=30, h=10, color=GREEN)
bar2.x = bar.x
# -------------------------- global variables ------------
startx = 0
mousedir = "stop"
